...
@register_model_architecture('lstm', 'lstm_myNMT')
def lstm_myNMT(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', args.encoder_embed_dim)
    args.encoder_layers = getattr(args, 'encoder_layers', args.encoder_layers)
    args.encoder_dropout_in = getattr(args, 'encoder_dropout_in', 0)
    args.encoder_dropout_out = getattr(args, 'encoder_dropout_out', args.dropout)
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', args.decoder_embed_dim)
    args.decoder_layers = getattr(args, 'decoder_layers', args.decoder_layers)
    ...
    args.decoder_hidden_size = getattr(args, 'decoder_hidden_size', args.decoder_hidden_size)
